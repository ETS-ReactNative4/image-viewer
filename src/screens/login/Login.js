...
class Login extends Component {
    ...
    loginClickHandler = () => {
        ...
        if (this.state.username === "upgradava" && this.state.password === "Upgrad2019") {
            sessionStorage.setItem('username','admin');
            sessionStorage.setItem('access-token', '11172478564.1312364.3fc40943b195455abe02a250a9a0d1aa');
